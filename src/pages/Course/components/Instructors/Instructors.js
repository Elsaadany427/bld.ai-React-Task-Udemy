      ...
      <div className="row">
        {course.instructors.map((instructor) => (
          <div className="col-md-12 mt-4" key={instructor.id}>
            ...
            <p className="instructors-role">{instructor.job}</p>
                    ...
                    <ul>
                      ...
                      <li className="d-flex align-items-center">
                        ...
                        <span className="ms-3 mt-1">
                          {instructor.reviews_num} Reviews
                        </span>
                      </li>
                      <li className="d-flex align-items-center">
                        <i className="fa fa-users" aria-hidden="true"></i>
                        <span className="ms-3 mt-1">
                          {instructor.students_num} Students
                        </span>
                      </li>
                      <li className="d-flex align-items-center">
                        <i className="fa fa-play-circle" aria-hidden="true"></i>
                        <span className="ms-3 mt-1">
                          {instructor.courses_num} Courses
                        </span>
                      </li>
                    </ul>
                  </div>
            ...
            <p className="instructors-desc">
              {showMore
                ? `${instructor.bio.join()}`
                : `${instructor.bio.join().substring(0, 250)}`}
              <button
